        ...
        { user ?  <>
          <UserButton>
            <UserButton.MenuItems>
              ...
              onClick={()=>router.push('/cart')}></UserButton.Action>
            </UserButton.MenuItems> 

            <UserButton.MenuItems>
               <UserButton.Action label="My Orders" labelIcon={<BagIcon/>}
              onClick={()=>router.push('/my-orders')}></UserButton.Action>
            </UserButton.MenuItems>
          </UserButton>
        ...
        {isSeller && <button onClick={() => router.push('/seller')} className="text-xs border px-4 py-1.5 rounded-full">Seller Dashboard</button>}
          ...
          <UserButton>
            <UserButton.MenuItems>
              ...
              onClick={()=>router.push('/')}></UserButton.Action>
            </UserButton.MenuItems>

            <UserButton.MenuItems>
              <UserButton.Action label="Products" labelIcon={<BoxIcon/>}
              onClick={()=>router.push('/all-products')}></UserButton.Action>
            </UserButton.MenuItems>
